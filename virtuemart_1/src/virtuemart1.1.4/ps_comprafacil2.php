...
class ps_comprafacil2 {

	var $payment_code = "CF";
    var $classname = "ps_comprafacil2";
  ...
  /**
   ...
   function configfile_writeable() {
		...
		echo(CLASSPATH ."payment/".$this->classname.".cfg.php");
  ...
  ***************************************************************************/
   ...
   function getReferenceFromWebService($total, $order_number, $email, &$reference, &$entity, &$value, &$error){
		...
		try 
		{
			...
			$soap = '<SaveCompraToBDValor2 xmlns="http://hm.comprafacil.pt/SIBSClick/webservice/">';
			...
			//echo str_replace(">", "&gt;", str_replace("<", "&lt;", $soap ));
